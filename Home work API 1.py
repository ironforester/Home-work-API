...
# Уважаемый проверяющий моё ДЗ, ответье, пожалуйста, на несколько вопросов: 1. Как определить минимальный набор заголовков headers, чтобы получить ответ от сервера? 2. Как определить минимальный набор параметров в зависимости от того, что хотим получить от сервера? 3. Как загрузить несколько файлов на яндекс диск? В документации Яндекса явных ответов не нашёл.